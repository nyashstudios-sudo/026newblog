...
export default function LoginPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const target = data.user.role === 'admin' ? '/admin' : data.user.role === 'author' ? '/author/dashboard' : '/';
      router.push(target);
    } catch {
        ...
        <div className="auth-form-wrap">
          <div className="form-header">
            ...
            <p className="form-subtitle">
              Don&apos;t have an account? {settings.enableRegistration !== false ? <Link href="/auth/register">Sign up free</Link> : 'Contact the administrator'}
            </p>
          </div>
