-- 026Newsblog sample seed data
-- Run AFTER supabase/migration.sql (Supabase SQL Editor or `supabase db reset`).
...
values
 ('g1000000-0000-0000-0000-000000000001', v_ada, 80.00, 10240.00, 128.0, 1.50, '+254712345001', 'MPESA00ABC1', 'completed', now() - interval '20 days', now() - interval '22 days'),
 ('g1000000-0000-0000-0000-000000000002', v_ada, 60.00, 7680.00, 128.0, 1.25, '+254712345001', null, 'pending', null, now() - interval '1 day');
